...
public class Main {
     ...
     */
    private final static String apiKey = "sk_test_Kq1GyHirDCm9SqH8W1Ca9af5";

    /**
     * Pingpp 管理平台对应的应用 ID，app_id 获取方式：登录 [Dashboard](https://dashboard.pingxx.com)->点击你创建的应用->应用首页->应用 ID(App ID)
     */
    private final static String appId = "app_X5KSyHubbXbDCuPW";
   ...
   */
    ...
    // 你生成的私钥路径
    private final static String privateKeyFilePath = "/data/jnwtv/resource/client/rsa_private_key.pem";
