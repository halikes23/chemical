...
public class StringUtils {
	...
	* @return boolean
	 ...
	 * @throws
	 */
	public static String stringChg(String str) {
		str.replace("[", "\\[") ;
		str.replace("]", "\\]") ;
		return  str ; 
	}
     ...
     * @param @param objVersion
     * @param @param tagVersion
     * @param @return    设定文件
     * @return int    返回类型
     */
...
//    	System.out.println(stringChg("123[123123]12"));
    	System.out.println(compareVersion("3.9.4" , "3.9.4"));
