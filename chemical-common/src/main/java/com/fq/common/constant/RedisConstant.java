...
public class RedisConstant {
	...
	//用户访问fan/commitnewchapter接口记录KEY
	public static final String PREFIX_FANS_COMMIT_NEW_CHAPTER = "uar:fcnc:" ;
	
	public static final String KEY_PROMOTE_COUNTER="promote:counter" ;
	
	public static final String KEY_PROMOTE_LINK_CODE="promote:linkcode" ;
