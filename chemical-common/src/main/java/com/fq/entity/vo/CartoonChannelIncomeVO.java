...
public class CartoonChannelIncomeVO {
	...
	private String subsidySplitTatio ; 
	...
	public String getSubsidySplitTatio() {
		return subsidySplitTatio;
	}
	public void setSubsidySplitTatio(String subsidySplitTatio) {
		this.subsidySplitTatio = subsidySplitTatio;
	}
