...
import com.fq.common.spsysinfo.Level2SpSysInfoKey;
import com.fq.common.spsysinfo.Level3SpSysInfoKey;
...
public class SpSysInfoDAO extends BaseDAO{
	...
	public List<SystemInfoVO> queryRegisterChanneParaInfoList(
			Map<String, Object> paramMap) {
		return getSqlMapClientTemplate().queryForList("SpSysInfoDAO.queryRegisterChanneParaInfoList" , paramMap);
	}

	public Integer queryRegisterChanneParaInfoListTotals(
			Map<String, Object> paramMap) {
		return (Integer) getSqlMapClientTemplate().queryForObject("SpSysInfoDAO.queryRegisterChanneParaInfoListTotals" , paramMap);
	}
