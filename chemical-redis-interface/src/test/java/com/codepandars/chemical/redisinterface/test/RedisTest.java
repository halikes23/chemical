package com.codepandars.chemical.redisinterface.test;
...
import com.codepandars.chemical.redisinterface.command.impl.incr.IncrResponse;
...
public class RedisTest {
	...
	public void test() {
		...
		ICommand incrCommand = CommandFactory.getFactory(incrRequest).build(incrRequest) ;
